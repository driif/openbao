...
- [ ] Add KMIP server configuration docs to transit engine documentation
- [ ] Document supported KMIP operations and version (1.2-1.4)
- [ ] Document cert-to-role authentication model
